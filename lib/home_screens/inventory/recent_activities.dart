...
class ActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: F_ActivityPage(),
    );
  }
}

class F_ActivityPage extends StatefulWidget {
  @override
  _F_ActivityPageState createState() => _F_ActivityPageState();
}

class _F_ActivityPageState extends State<F_ActivityPage> {
  int _n = 0;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          primaryText: null,
          secondaryText: 'Recent Activities',
          tabBarWidget: null,
        ),
      ),
      body: Container(
